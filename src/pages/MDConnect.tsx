...
const MDConnect: React.FC = () => {
  return (
    <PageLayout className="bg-white" mainClassName="pt-20 space-y-24">
      {/* Hero Section */}
      <section
        className="relative overflow-hidden bg-gradient-to-br from-[#283692] via-[#007FFF] to-[#283692] py-32 px-6 sm:px-12 md:px-20 text-white"
      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-5xl text-center">
          ...
          <p className="mx-auto mb-10 max-w-4xl text-xl leading-relaxed text-white/95 sm:text-2xl">
          ...
          <a
            href="#learn-more"
            className="inline-flex items-center gap-3 rounded-2xl bg-white px-10 py-5 text-lg font-bold text-[#283692] shadow-xl transition-all hover:scale-105 hover:shadow-2xl"
          >
            Learn More
      ...
      <section
        id="learn-more"
        className="bg-gradient-to-br from-white to-[#007FFF]/5 py-24 px-6 sm:px-12 md:px-20"
        data-animate="fade-up"
      >
      ...
      {/* CTA Section */}
      <section
        className="relative overflow-hidden bg-gradient-to-br from-[#283692] to-[#007FFF] py-24 px-6 sm:px-12 md:px-20 text-white"
        data-animate="fade-up"
      >
        <div className="absolute inset-0 opacity-10">
          <Heart className="absolute top-10 right-20 h-32 w-32" />
          <Heart className="absolute bottom-10 left-20 h-24 w-24" />
        </div>
        ...
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mb-10 max-w-3xl text-xl text-white/95">
