  ...
  return (
    <PageLayout className="bg-[#f7f9ff]" mainClassName="pt-24 pb-24 space-y-24">
      <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#1f2a44] via-[#1c3e73] to-[#0f88ff] px-6 py-24 text-white sm:px-12 md:px-20" data-animate="fade-up">
        ...
        {/* Sign-up box moved here for mobile-first access */}
          ...
          <div className="space-y-10">
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              {OnboardingHighlights.map((highlight) => (
                <div key={highlight.title} className="rounded-xl border border-[#e5ecff] bg-white p-4">
                  <div className="flex items-center gap-3">
                    <div className="rounded-lg bg-[#eff4ff] p-2 text-[#3a4d9f]">
                      {highlight.icon}
                    </div>
                    <h3 className="font-semibold text-[#16213a]">{highlight.title}</h3>
                  </div>
                  <p className="mt-3 text-sm leading-relaxed text-[#4b5876]">{highlight.copy}</p>
                </div>
              ))}
            </div>
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-[#16213a]">Your onboarding journey</h3>
              <ol className="space-y-4">
                <li className="flex items-start gap-3">
                  <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#eff4ff] text-xs font-bold text-[#3a4d9f]">
                    1
                  </span>
                  <div>
                    <p className="font-semibold text-[#1f2a44]">Create account & verify identity</p>
                    <p className="mt-1 leading-relaxed text-[#4b5876]">Secure registration with HIPAA-compliant verification.</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#eff4ff] text-xs font-bold text-[#3a4d9f]">
                  ...
                  <div>
                    <p className="font-semibold text-[#1f2a44]">Add beneficiary & care details</p>
                    <p className="mt-1 leading-relaxed text-[#4b5876]">Tell us about your loved one and their healthcare needs.</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#eff4ff] text-xs font-bold text-[#3a4d9f]">
                  ...
                  <div>
                    <p className="font-semibold text-[#1f2a44]">Wallet activation</p>
                    <p className="mt-1 leading-relaxed text-[#4b5876]">You receive a DiaspoCare wallet with transparent, fraud-safe payments.</p>
                  </div>
                </li>
              </ol>
            </div>
