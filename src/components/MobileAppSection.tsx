...
const MobileAppSection: React.FC = () => {
  return (
    <section className="py-24 px-6 sm:px-12 md:px-20 bg-gradient-to-br from-[#283692] via-[#007FFF] to-[#283692] relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <button className="flex items-center justify-center gap-3 px-6 py-4 rounded-2xl bg-white text-[#283692] font-bold hover:scale-105 transition-all shadow-lg">
