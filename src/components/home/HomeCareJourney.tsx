const CARE_STEPS = [
  {
    ...
    icon: "💸",
    accent: "from-primary/18 via-primary/8 to-accent/18",
  ...
  },
  {
    ...
    icon: "🧭",
    accent: "from-accent/18 via-primary/8 to-accent/16",
    iconBg: "bg-accent/12 text-accent",
    indicator: "bg-gradient-to-br from-accent/90 via-primary/85 to-secondary/85",
  ...
  },
  {
    ...
    icon: "🪙",
    accent: "from-secondary/18 via-secondary/6 to-primary/12",
  ...
  },
  {
    ...
    icon: "🧠",
    accent: "from-primary/18 via-primary/6 to-foreground/10",
    iconBg: "bg-primary/12 text-primary",
    indicator: "bg-gradient-to-br from-primary/85 via-foreground/70 to-primary/85",
    solutionAccent: "text-primary",
    accentDot: "bg-primary",
  },
  {
    ...
    icon: "💊",
    accent: "from-secondary/16 via-primary/6 to-accent/14",
    iconBg: "bg-secondary/12 text-secondary",
    indicator: "bg-gradient-to-br from-secondary/88 via-accent/85 to-primary/85",
    solutionAccent: "text-secondary",
    accentDot: "bg-secondary",
  },
  {
    ...
    icon: "🔬",
    accent: "from-accent/18 via-primary/6 to-secondary/16",
    iconBg: "bg-accent/12 text-accent",
    indicator: "bg-gradient-to-br from-accent/88 via-primary/85 to-secondary/85",
    solutionAccent: "text-accent",
    accentDot: "bg-accent",
  },
];
    ...
    <section id="care-journey" className="relative overflow-hidden py-24" data-animate="fade-up">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto flex max-w-4xl flex-col items-center text-center">
          <span className="inline-flex items-center gap-3 rounded-full border border-primary/20 bg-primary/5 px-5 py-2 shadow-md shadow-primary/10 backdrop-blur-sm">
            <span className="h-2.5 w-2.5 rounded-full bg-gradient-to-r from-primary to-secondary" />
            <span className="text-[0.72rem] font-semibold uppercase tracking-[0.32em] text-primary">
        ...
        <div className="relative mt-16">
          ...
          <div className="space-y-10">
            {CARE_STEPS.map((step, index) => (
              <article
                key={step.need}
                className="group relative grid items-center gap-8 overflow-hidden rounded-[2rem] border border-border/40 bg-white/95 px-6 py-10 shadow-xl shadow-primary/10 backdrop-blur-lg transition-transform duration-500 hover:-translate-y-2 hover:border-primary/25 hover:shadow-2xl md:grid-cols-[1fr_auto_1fr] md:px-12 animate-in fade-in slide-in-from-bottom-4 duration-700"
              ...
              >
                ...
                <div className="flex flex-col gap-6 text-left">
                  <div className="flex items-center gap-4">
                    <span
                      className={`flex h-12 w-12 items-center justify-center rounded-2xl border border-white/10 text-xl shadow-[0_1.5rem_3rem_-1.5rem_rgba(15,23,42,0.48)] backdrop-blur ${step.iconBg}`}
                    >
                      {step.icon}
                    </span>
                ...
                <div className="relative hidden flex-col items-center justify-center gap-4 md:flex">
                  <span
                    className={`flex h-16 w-16 items-center justify-center rounded-3xl text-lg font-semibold text-white shadow-[0_1.4rem_3.2rem_-1.8rem_rgba(59,130,246,0.5)] ring-2 ring-white/50 transition-all duration-500 group-hover:shadow-[0_1.6rem_3.6rem_-1.4rem_rgba(59,130,246,0.6)] group-hover:ring-white/70 ${step.indicator}`}
                  >
