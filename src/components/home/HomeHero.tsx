  ...
  return (
    ...
    >
      <div className="absolute inset-0">
        <div className="absolute left-[-18%] top-[-10%] h-[520px] w-[520px] rounded-full bg-[#ff444f]/15 blur-[180px]" />
        <div className="absolute right-[-10%] bottom-[-30%] h-[480px] w-[480px] rounded-full bg-[#231942]/12 blur-[160px]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,#ffffff_0%,rgba(255,255,255,0)_60%)]" />
      </div>
      ...
      <div className="container relative z-10 mx-auto grid max-w-6xl items-center gap-16 px-4 sm:px-6 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:px-8">
        <div className="space-y-9">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
            ...
            <Button asChild variant="brandOutline" size="lg" className="sm:min-w-[180px]">
