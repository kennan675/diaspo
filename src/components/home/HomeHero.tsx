  ...
  return (
    ...
    >
      <div className="absolute inset-0">
        ...
        />
        <div className="absolute inset-0">
          <div className="absolute inset-0 rounded-[60px] border border-white/5/50 bg-[linear-gradient(112deg,rgba(7,14,34,0.95)0%,rgba(16,38,82,0.87)55%,rgba(27,60,123,0.7)100%)]" />
          <div className="absolute inset-0 rounded-[60px]">
            <div className="absolute inset-0 rounded-[60px] bg-[radial-gradient(circle_at_15%_-10%,rgba(255,255,255,0.22),transparent_55%)]" />
            <div className="absolute inset-0 rounded-[60px] bg-[radial-gradient(circle_at_85%_10%,rgba(7,14,34,0.88),rgba(7,14,34,0.55)45%,transparent_68%)]" />
            <div className="absolute inset-0 rounded-[60px] bg-[radial-gradient(circle_at_80%_115%,rgba(255,68,79,0.18),transparent_60%)]" />
          </div>
          <div className="absolute inset-0 rounded-[60px] border border-white/5 mix-blend-screen" />
        </div>
