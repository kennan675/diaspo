...
export const DiaspoAnimatedBackground = () => {
  return (
    <div className="fixed inset-0 w-full h-full bg-gradient-to-br from-white via-[#007FFF]/5 to-[#283692]/10 -z-10">
      <Canvas
      ...
      >
        ...
        <directionalLight position={[-5, -5, -5]} intensity={0.2} color="#007FFF" />
        <pointLight position={[0, 0, 5]} intensity={0.3} color="#007FFF" />
        <pointLight position={[5, 5, 0]} intensity={0.2} color="#283692" />

        {/* Heartbeat/pulse spheres - representing care and vitality */}
        <HeartbeatSphere position={[-4, 2, -2]} scale={1.4} color="#007FFF" />
        <HeartbeatSphere position={[4, -1.5, -3]} scale={1.1} color="#ffffff" />
        <HeartbeatSphere position={[0, 3, 1]} scale={0.9} color="#283692" />
        ...
        <HeartbeatSphere position={[-3, -1, 2]} scale={0.7} color="#007FFF" />
        ...
        <SoftCloud position={[5, -2, -4]} scale={1.8} color="#007FFF" />
        <SoftCloud position={[0, 4, -6]} scale={2.2} color="#283692" />
        <SoftCloud position={[4, 1, -3]} scale={1.5} color="#e0f2fe" />
      ...
      {/* DiaspoCare blue glow - trust and healthcare */}
      <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-[#007FFF]/20 rounded-full blur-3xl" style={{ animation: 'pulse 6s ease-in-out infinite' }} />
      
      {/* Navy blue glow - professionalism */}
      <div 
        className="absolute bottom-1/4 right-1/4 w-[450px] h-[450px] bg-[#283692]/15 rounded-full blur-3xl" 
        style={{ animation: 'pulse 6s ease-in-out infinite', animationDelay: '2s' }} 
      />
      
      {/* Light accent */}
      <div 
        className="absolute top-1/2 right-1/3 w-[400px] h-[400px] bg-[#007FFF]/10 rounded-full blur-3xl" 
        style={{ animation: 'pulse 6s ease-in-out infinite', animationDelay: '4s' }} 
      />
    </div>
  );
};
